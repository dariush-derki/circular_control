...
# اندازه GIF3 هنگام کلیک
GIF3_SIZE = 200

# اندازه دکمه‌های اطراف
GIF_SIZE = 90
...
# حالت عادی = GIF2
frames_normal = load_gif(
    GIF2,
    GIF_SIZE
)

# حالت Hover = GIF1
frames_hover = load_gif(
    GIF1,
    GIF_SIZE
)

# حالت Click = GIF3
frames_click = load_gif(
    GIF3,
    GIF3_SIZE
)
...
class GifButton:
    ...
    def __init__(
        ...
        # Hover = GIF1
        self.frames_hover = frames_hover

        # Click = GIF3
        self.frames_click = frames_click
